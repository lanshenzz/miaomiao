...
<style>
 .messageBox{width:200px;height: 120px;border:1px #ccc solid;border-radius: 4px;background: white;box-shadow:3px 3px 3px 3px;position: absolute;
 left:20%;top:40%;margin:-70px 0 0 -100}
